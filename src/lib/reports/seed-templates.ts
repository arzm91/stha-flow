      ...
      pages: [
        {
          ...
          blocks: [
            ...
            { id: uid(), type: 'kpi', x: 285, y: 140, w: 220, h: 110,
              props: { label: 'Qtd. Produzida Total', dataSource: { source: 'ordens_producao', columns: ['qtd_produzida'], period: '30d', limit: 500 }, aggregate: 'sum', field: 'qtd_produzida', color: '#0f766e', unit: 'un' } },
            ...
            { id: uid(), type: 'table', x: 40, y: 315, w: 710, h: 400,
              props: { dataSource: { source: 'ordens_producao', columns: ['numero','status','qtd_planejada','qtd_produzida','inicio_em','fim_em'], period: '30d', limit: 25 },
