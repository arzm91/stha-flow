...
export const WIDGET_SOURCES: WidgetSource[] = [
  ...
  { key: "chart.paradas.pareto", tipo: "chart", grupo: "Manutenção", label: "Pareto de paradas", description: "Mostra os motivos com maior tempo de parada no período", colSpan: 6, rowSpan: 3, priority: 52 },
