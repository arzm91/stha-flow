  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <AutoGenerateDialog
        ...
        title="Produtividade — última produção"
        description={`Deseja gerar o relatório detalhado da OP ${op.numero} que acabou de ser finalizada?`}
        search={{ equipamento: op.equipamento_id, ordem: op.id }}
      />
    </Dialog>
  );
}
