...
import { ParadasSection } from "@/components/paradas/ParadasSection";
...
function OPPage() {
  ...
  const op = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select("*, produto:produto_id(id,nome,codigo,unidade), equipamento:equipamento_id(id,codigo,nome,tag_nomes,tag_velocidade_producao,tag_producao_total,tag_indices,capacidade_hora,capacidade_dia,capacidade_mes,capacidade_unidade), tanque:tanque_destino_id(nome,codigo)")
  ...
  const equip = op.data.equipamento as { tag_nomes?: string[]; tag_velocidade_producao?: string | null; tag_producao_total?: string | null; tag_indices?: string[] | null; nome?: string; capacidade_hora?: number | null; capacidade_dia?: number | null; capacidade_mes?: number | null; capacidade_unidade?: string | null } | null;
  ...
  const tagIndices = (equip?.tag_indices ?? []) as string[];
